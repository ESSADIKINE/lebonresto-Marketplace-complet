                                ...
                                <div className="card border-0 shadow-sm h-100 rounded-4 overflow-hidden">
                                    ...
                                    <div className="card-body p-4">
                                        ...
                                        <h4 className="fw-bold mb-3">
                                            <Link href={`/blog/${post.id}`} className="text-dark text-decoration-none hover-primary">{post.title}</Link>
                                        </h4>
                                        <p className="text-muted mb-4">{post.excerpt}</p>
                                        <Link href={`/blog/${post.id}`} className="fw-bold text-primary text-decoration-none">Lire la suite &rarr;</Link>
                                    </div>
                                </div>
                            </div>
                        ))}
