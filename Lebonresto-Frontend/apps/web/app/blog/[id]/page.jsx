...
export default function BlogDetail({ params }) {
    ...
    // Since this is a client component (due to potential interactive children or just preference for consistency with other pages),
    // we can access params directly. If we needed searchParams, we'd use useSearchParams().
    // However, for [id], params.id is available.
    // Note: In Next.js 13+, params is a prop.
                            ...
                            <div className="position-relative">
                                ...
                                <nav id="breadcrumbs" className="breadcrumbs">
                                    <ul>
                                        ...
                                        <li><Link href="/blog">Blog</Link></li><MdArrowForwardIos className='ms-2' />
                                        <li>Blog Detail</li>
                                    </ul>
                                </nav>
                            </div>
