                            ...
                            <div className="helpNav">
                                <nav id="single-helps" className="h-100 flex-column align-items-stretch pe-4">
                                    <nav className="nav nav-pills light flex-column">
                                        <ScrollLink className="nav-link ms-3 my-1" to="item-1" smooth={true} duration={500} offset={-100} style={{ cursor: 'pointer' }}>How Do I Add Or Change My Billing Details?</ScrollLink>
                                        <ScrollLink className="nav-link ms-3 my-1" to="item-2" smooth={true} duration={500} offset={-100} style={{ cursor: 'pointer' }}>How do I purchase an item?</ScrollLink>
                                        <ScrollLink className="nav-link ms-3 my-1" to="item-3" smooth={true} duration={500} offset={-100} style={{ cursor: 'pointer' }}>How do refunds work?</ScrollLink>
                                        <ScrollLink className="nav-link ms-3 my-1" to="item-4" smooth={true} duration={500} offset={-100} style={{ cursor: 'pointer' }}>I'm trying to find a specific item</ScrollLink>
                                        <ScrollLink className="nav-link ms-3 my-1" to="item-5" smooth={true} duration={500} offset={-100} style={{ cursor: 'pointer' }}>Envato and the Envato Market sites</ScrollLink>
                                        <ScrollLink className="nav-link ms-3 my-1" to="item-6" smooth={true} duration={500} offset={-100} style={{ cursor: 'pointer' }}>Purchasing Items As A Member</ScrollLink>
                                        <ScrollLink className="nav-link ms-3 my-1" to="item-7" smooth={true} duration={500} offset={-100} style={{ cursor: 'pointer' }}>Buyers Guide to YouTube Content ID & ...</ScrollLink>
                                    </nav>
                                </nav>
                            </div>
                        </div>
                        ...
                        {articles.map((item, index) => {
                            return (
                                <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12" key={index}>
                                    <Link href="/help-center" className="popularArticles">
